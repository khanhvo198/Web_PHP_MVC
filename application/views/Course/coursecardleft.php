<div class="row course justify-content-center" uk-scrollspy="cls:uk-animation-slide-left; repeat:true; delay: 200">
    <div class="col-md-2 text-center d-flex flex-column justify-content-center number course-border-right"><?php echo $number ?></div>
    <div class="col-md-9" style="margin-top: 3em; margin-bottom: 3em;">
        <h2><?php echo $name ?></h2>
        <div class="row">
            <div class="col-md-6" style="margin-bottom: 3em;">
                <img src="<?php echo $this->get_url($image); ?>" alt="">
            </div>
            <div class="col-md-6">
